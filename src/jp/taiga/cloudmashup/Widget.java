...
//	public static PendingIntent clickNextButton(Context context) {
//
...
//	}
//
//	public static PendingIntent clickSaveButton(Context context) {
//
//		Toast.makeText(context, "登録されました", Toast.LENGTH_SHORT).show();
//		
//		Intent intent = new Intent();
//		intent.setAction("SAVE_WIDGET");
//		return PendingIntent.getBroadcast(context, 2, intent,
//				PendingIntent.FLAG_UPDATE_CURRENT);
//
//	}
