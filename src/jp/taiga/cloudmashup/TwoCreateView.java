...
public class TwoCreateView {
	...
	public void createTwoCloud(final Context context, final FrameLayout layout,
			final int top, final Boolean type, final Boolean leftRight,
			final int x, final int y) {
		cloudView = new TwoCloudView(context) {
		...
		if (type) {
			...
			transAnimator.addListener(new AnimatorListenerAdapter() {
				...
				public void onAnimationEnd(Animator animation) {
					...
					createTwoCloud(context, layout, top, type, leftRight, x, y);
				}
		...
		cloudButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				try {
					...
					// insertで行に追加
					db.execSQL("insert into ideas(keywordA,keywordB,keywordC) values ('" + wordAString
							+ "','" + wordBString + "','"+null+"');");
					...
					objectAnimator.addListener(new AnimatorListenerAdapter() {
						...
						public void onAnimationEnd(Animator animation) {
							...
							layout.removeView(cloudView);
							if (!type) {
								createTwoCloud(context, layout, top, type,
										leftRight, x, y);
							}
						}
